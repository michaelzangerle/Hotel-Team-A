...
/**
 * Step 2, Auflistung aller ausgewählten Rechnungspostionen und Bearbeitung der Zahlungsart
...
public class InvoiceStep2 extends AbstractFormInvoice implements IActionResult, Observer {
    ...
    private void initControls() {
        ...
        labelTotalTaxes.setText("Total Taxes 123,45 €");
        labelTotalPrice.setText("TOTAL 12345,67€");

        jScrollPane2.setViewportView(tableTypePayment);

        labelOpen.setText("Open 41,09€");
